/* Contas a receber — total pendente nesta semana. @EMPRESA e @INI_SEMANA parametrizados. */
...
WHERE CP.TOTAL > 0
  ...
  AND CP.DATAVENCIMENTO >= @INI_SEMANA
  AND CP.DATAVENCIMENTO <  DATEADD(7 DAY TO @INI_SEMANA)
